...
AUTH_USER_MODEL = 'usuarios.Usuario'   #para el sistema de autenticacion de usuario utiliza este modelo
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ods2030blog@gmail.com'
EMAIL_HOST_PASSWORD = 'sapgedhnmosdzont'
